...
public extension UIView {
    ...
    @discardableResult func stretch(constant: CGFloat) -> UIView {
        return self.width(constant: constant)
    }
    
    @discardableResult func tall(constant: CGFloat) -> UIView {
        return self.height(constant: constant)
    }
...
public extension UIView {
    ...
    @discardableResult func alignAllEdgesWithContainer() -> UIView {
        return alignAllEdgesWithSuperview()
    }
...
public extension UIView {
    @discardableResult func topOf(_ view: UIView, constant: CGFloat = 0) -> UIView {
        return self.toTopOf(view, constant: constant)
    }
    
    @discardableResult func bottomOf(_ view: UIView) -> UIView {
        return self.toBottomOf(view)
    }
